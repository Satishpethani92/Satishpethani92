...
🛠 Tech Stack
💻   React | React-native | Android | fluter <br />
🌐   HTML | CSS | JavaScript | Bootstrap | Node.js | Angular | Vuejs | Reactjs | Express<br />
🛢   MySQL | MongoDB | Postgres<br />
🔧   Git | Gitlab | Bitbucket<br />
